...
//ArrayList -> Fish
//ArrayList -> Deco
//add/remove fish function (fish) (either with name or position)
...
public class Aquarium {
    ...
    public void printAquarium() {
        ...
        String aquariumAsString = Arrays.deepToString(aquarium); //1 = tropical fish (saltwater) 2 = blue fish (freshwater) 3 = deo
    ...
    ArrayList<String> decos = new ArrayList<>();
