package DifficultVersion;

import DifficultVersion.Game;
...
public class GameIO extends JFrame {
  ...
  public GameIO(Game game, int scale, double cellMargin) {
    ...
    inputMap = Map.of(KeyEvent.VK_UP, game::moveUp, KeyEvent.VK_DOWN, game::moveDown,
        ...
        game::resetField);
    colorList = List.of(Color.LIGHT_GRAY, Color.BLACK, Color.RED, Color.BLUE, Color.GREEN, Color.GRAY, Color.RED, new Color(138,43,226));
